          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="p-4 rounded-lg bg-slate-50/70 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                {/* Allocation Required */}
                <label className="flex items-start gap-2.5 p-3 rounded-md bg-white dark:bg-[#211D20] border border-slate-200 dark:border-[#40383D] cursor-pointer hover:border-purple-300 dark:hover:border-purple-600 transition">
                  <input
                    type="checkbox"
                  ...
                  <div className="text-xs">
                    ...
                    <span className="text-slate-500 dark:text-slate-400 text-[10px]">Needs allocated days</span>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-2.5 p-3 rounded-md bg-white dark:bg-[#211D20] border border-slate-200 dark:border-[#40383D] cursor-pointer hover:border-purple-300 dark:hover:border-purple-600 transition">
                  ...
                  <div className="text-xs">
                    ...
                    <span className="text-slate-500 dark:text-slate-400 text-[10px]">Needs HR approval</span>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-2.5 p-3 rounded-md bg-white dark:bg-[#211D20] border border-slate-200 dark:border-[#40383D] cursor-pointer hover:border-purple-300 dark:hover:border-purple-600 transition">
                  ...
                  <div className="text-xs">
                    ...
                    <span className="text-slate-500 dark:text-slate-400 text-[10px]">Paid time off</span>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-2.5 p-3 rounded-md bg-white dark:bg-[#211D20] border border-slate-200 dark:border-[#40383D] cursor-pointer hover:border-purple-300 dark:hover:border-purple-600 transition">
                  ...
                  <div className="text-xs">
                    <span className="font-semibold text-slate-800 dark:text-slate-100 block flex items-center gap-1">
                      <Power className="h-3 w-3 text-purple-600 dark:text-purple-400" />
                      Active Status
                    </span>
                    <span className="text-slate-500 dark:text-slate-400 text-[10px]">Available for selection</span>
                  </div>
                </label>
              </div>
            </div>
