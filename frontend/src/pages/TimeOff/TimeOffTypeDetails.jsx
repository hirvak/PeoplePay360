        ...
        <CardHeader className="border-b border-slate-100 bg-slate-50/50 p-6 flex flex-row items-center justify-between">
          ...
          <div>
            {timeOffType.is_active ? (
              ...
              <Badge className="bg-slate-100 text-slate-700 border-slate-200 font-semibold px-3 py-1 text-xs">
            ...
            <div className="p-4 rounded-lg bg-slate-50/70 border border-slate-100">
              ...
              <div>
                {timeOffType.requires_allocation ? (
                  ...
                  <Badge variant="outline" className="text-slate-600 border-slate-200 font-medium">
                    No
                  </Badge>
                )}
              </div>
